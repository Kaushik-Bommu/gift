            ...
            <div className="py-32 relative">
              ...
              <motion.div initial={{opacity:0, scale: 0.95}} whileInView={{opacity:1, scale: 1}} transition={{delay: 3.5, duration: 2}} className="my-16">
                <span className="font-display-hero text-[40px] md:text-[64px] text-[#ff7a33] drop-shadow-[0_0_20px_rgba(255,122,51,0.4)] block leading-relaxed">
                  you were on your periods that day
                </span>
              </motion.div>
            ...
            <div className="py-48 text-center min-h-screen flex flex-col justify-center items-center">
              ...
              <div className="mt-16 font-body-main text-[20px] md:text-[28px] leading-relaxed max-w-4xl opacity-90 space-y-12">
                ...
                <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay: 4.5, duration: 2}}>
                  one month would also not be enough,
                </motion.div>
